...
<div class={`item ${type}`}>
    ...
    <text xlink:href="./{type}/" class="card-description-line card-category font-hitchcock" x="190" y="290">Select Category</text>
    <text xlink:href="./{type}/{category ?? ''}" class="card-description-line card-element font-sans" x="190" y="340">Select Element</text>
	</svg>
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 786 563"
    ...
    <text class="card-credits font-sans" x="230" y="542">©2020 Bully Pulpit Games LLC www.bullypulpitgames.com</text>
	</svg>
</div>
